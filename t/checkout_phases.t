#!perl -wT
# $Id: /local/CPAN/Handel-Storage-RDBO/t/checkout_phases.t 1243 2008-01-20T04:05:18.816539Z claco  $
use strict;
use warnings;

BEGIN {
    use lib 't/lib';
    use Handel::Test tests => 50;
...
## add a phase and import
{
    ...
    Handel::Test::RDBO::Checkout->add_phase('NEWPHASE', 23, 1);
