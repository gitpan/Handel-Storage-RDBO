#!perl -wT
# $Id: /local/Handel-Storage-RDBO/trunk/t/storage_rdbo_search_items.t 1787 2007-06-23T21:05:35.855248Z claco  $
use strict;
use warnings;
...
## get the items via items
{
    ...
    foreach my $result (@results) {
        ...
        is(refaddr $storage->item_storage, refaddr $result->storage, 'result storage is original storage');
        like(ref $result->storage_result, qr/Handel::Schema::RDBO::Cart::Item::[A-F0-9]{32}/, 'class is composed class style');
    };
};
